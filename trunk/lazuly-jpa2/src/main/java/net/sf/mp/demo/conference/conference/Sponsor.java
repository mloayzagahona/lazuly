...
public class Sponsor {
    ...
    @OneToMany (targetEntity=net.sf.mp.demo.conference.conference.Speaker.class, fetch=FetchType.LAZY, mappedBy="sponsorId", cascade=CascadeType.REMOVE)//, cascade=CascadeType.ALL)
