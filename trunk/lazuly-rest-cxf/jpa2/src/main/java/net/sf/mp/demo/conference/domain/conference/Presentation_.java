...
public class Presentation_ {
    ...
    public static volatile SetAttribute<Presentation, Evaluation> evaluationPresentationViaPresentationId;

    public static volatile SetAttribute<Presentation, Speaker> speakerSpeakerPresentationViaId;
